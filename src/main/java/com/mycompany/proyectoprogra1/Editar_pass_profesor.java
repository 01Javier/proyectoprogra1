 ...
 * @author javier
 */
public class Editar_pass_profesor extends javax.swing.JFrame {

    /**
     * Creates new form Editar_pass_profesor
     */
    private Profesor Editar_pass_profesor;
    
    public Editar_pass_profesor() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Editar mi contraseña");
        
        jLabel1.setText("Profesor:" + Proyectoprogra1.profesorLogeado.toString());
        
        Editar_pass_profesor = Proyectoprogra1.profesorLogeado;
        Editar_pass.setText(Editar_pass_profesor.password);
    }
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        Editar_pass_profesor.password = Editar_pass.getText();
